...
import { getMatches, getMatch, respondToMatch, createMatch, studentApplyToNeed, triggerAutoMatch } from "../controllers/matchmakingController.js";
...
matchmakingRouter.post("/auto-match", authenticate, authorize("admin"), triggerAutoMatch);
